...
class TestResearchFlowStatus(TestCase):
    ...
    def test_load_from_json(self):
        ...
        self.assertEqual("", rp_sf[0]._data_dir)
        ...
        self.assertEqual("exsf1datadir", ex_sf[0]._data_dir)
        ...
        self.assertEqual("exsf2datadir", ex_sf[1]._data_dir)
        ...
        self.assertEqual("exsf3datadir", ex_sf[2]._data_dir)
        ...
        self.assertEqual("pwsf1datadir", pw_sf[0]._data_dir)
        ...
        self.assertEqual("pwsf2datadir", pw_sf[1]._data_dir)
